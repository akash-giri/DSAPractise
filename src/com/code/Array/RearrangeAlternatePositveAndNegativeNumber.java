...
public class RearrangeAlternatePositveAndNegativeNumber {
    ...
    {
        // The following few lines are similar to partition process of QuickSort.  The idea is to
        // consider 0 as pivot and divide the array around it.
        int i = -1, temp = 0;
        for (int j = 0; j < n; j++)
        {
            if (arr[j] < 0)
