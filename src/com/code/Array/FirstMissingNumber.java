...
public class FirstMissingNumber {
    ...
    public static int firstMissingNumbers(int [] array,int n)
    {
        for(int itr = 0; itr < n; itr++){
            while((array[itr] >= 1 && array[itr] <= n) && (array[itr] != array[array[itr] - 1])){
                int pos = array[itr] - 1;
                int temp=array[itr];
                array[itr]=array[pos];
                array[pos]=temp;
        ...
        for(int itr = 0; itr < n; itr++){
            if(itr+1 != array[itr]) return itr+1;
        }
        return n+1;
    }
